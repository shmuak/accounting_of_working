...
const AddUser = () => {
  ...
  const handleCreate = async () => {
    if (!newUser.login || !newUser.password || !newUser.role || (newUser.role !== 'ADMIN' && newUser.role !== 'STOKEKEEPER' && newUser.role !== 'DISPATCHER' && !newUser.workshop)) {
  ...
  return (
    <div className={styles.formContainer}>
      <div className={styles.formCard}>
        ...
        {newUser.role && newUser.role !== 'ADMIN' && newUser.role !== 'STOKEKEEPER' && newUser.role !== 'DISPATCHER' && (
          <div className={styles.formGroup}>
